...
<div class="m-5">
  <div  class="row">
  <div class="col-6">
     <h2 class="text-center"> Quản trị Invoice</h2>
    <a class="btn btn-success" href="{{route('admin.invoices.create')}}" >Thêm mới</a>
         ...
         <tr>
           <td>{{$item->id}}</td>
            ...
            <td><button class="btn btn-primary">
              <a style="text-decoration: none"  class="text-white" href="{{route('admin.invoices.edit',['id' => $item->id ])}} ">Update</a></button>
            </td>
           <td>
